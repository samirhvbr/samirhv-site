...
return [
    'meta_description' => 'Monitor the usage of your AI plans — fourteen providers, from Anthropic Claude and OpenAI Codex to Kimi, Grok and ShvIA — in your system bar on Linux and macOS, and in a terminal TUI on all three systems. How to install on each OS.',

    'kicker' => 'AI usage monitor',
    'byline' => 'A project by :akita. The GNOME and macOS desktop integrations shown here were written in :fork and adopted upstream.',
    'byline_fork' => "Samir's fork",

    'intro_what' => ':name shows how much of your AI plans you have already used — :anthropic, :codex, :zai, :openrouter, :deepseek and nine more — right in your system bar, with the usage bars for the :window and :weekly windows beside the clock and a menu holding the full breakdown.',
    'intro_window' => '5-hour window',
    'intro_weekly' => 'weekly',
    'intro_how' => 'It is a :backend with three interfaces: the :waybar widget and a :tui (cross-platform), the :gnome extension (Linux) and the :menubar app (macOS). All of them read the same :json from the binary — the authentication logic and each provider live only in the auditable Rust.',
    ...
    'features' => 'Features',
    'feature_multi' => 'Fourteen providers',
    'feature_multi_desc' => 'Claude, Codex, Z.AI, OpenRouter, DeepSeek, Kimi, Grok, MiniMax, ShvIA and more, in one place.',
    'feature_native' => 'Native UI per OS',
    'feature_native_desc' => 'Waybar and a GNOME extension on Linux, the menu bar on macOS.',
    'feature_tui' => 'Cross-platform TUI',
    'feature_tui_desc' => '`ai-usagebar-tui` runs in any terminal, on all three systems, even over SSH.',
    ...
    'windows_prereqs_lead' => 'You need the :rust:',
    'windows_prereqs_rust' => 'Rust toolchain',
    'cmt_win_tui' => 'the full terminal dashboard',
    'cmt_win_json' => 'one usage reading, readable',
    'windows_build' => '2. Build and run',
    'windows_note' => 'Credentials live in :claude_path / :codex_path — run :claude/:codex once to create them. No API key is needed for those two: the tool reads the OAuth the official CLIs already wrote.',
    'windows_warn' => 'The :waybar and does not apply to Windows, and there is no tray app in the tree: what runs natively on Windows is :tui and :json.',
